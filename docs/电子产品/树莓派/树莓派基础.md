...
1. 下载 SD Memory Card Formatter 。
   ...
   ![image-20230214232332109](树莓派基础/image-20230214232332109.png)
...
4. 插入读卡器后，电脑显示增加了两个磁盘
   ...
   ![image-20230214233719928](树莓派基础/image-20230214233719928.png)

5. 选择boot盘，并选择 Quick format (Overwrite format 清除更彻底，但比较耗时)，点击Format。

   ![image-20230214233800629](树莓派基础/image-20230214233800629.png)
